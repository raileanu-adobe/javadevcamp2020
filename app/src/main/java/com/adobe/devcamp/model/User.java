...
public final class User {
    ...
    @JsonCreator
    public User(@JsonProperty( value = "firstName") String firstName, @JsonProperty( value = "lastName") String lastName, @JsonProperty( value = "email") String email, @JsonProperty( value = "profile") Profile profile) {
    ...
    public static class Profile {
        ...
        @JsonCreator
        public Profile(@JsonProperty( value = "gender") Gender gender,@JsonProperty( value = "dateOfBirth") LocalDate dateOfBirth,@JsonProperty( value = "interests") List<Domain> interests) {
            this.gender = gender;
