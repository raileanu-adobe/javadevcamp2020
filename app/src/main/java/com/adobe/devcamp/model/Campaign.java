...
public final class Campaign {
    ...
    private final Integer adveriserId;

    public Campaign(String name, Long startTime, Long endTime, Target target, Integer adveriserId) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(name, campaign.name) &&
                ...
                Objects.equals(adveriserId, campaign.adveriserId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, startTime, endTime, target, adveriserId);
    }
