...
public final class Campaign {
    ...
    private final Integer advertised;

    public Campaign(String name, Long startTime, Long endTime, Target target, Integer advertised) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getName(), campaign.getName()) &&
                ...
                Objects.equals(getAdvertised(), campaign.getAdvertised());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getName(), getStartTime(), getEndTime(), getTarget(), getAdvertised());
    }
